...
class _ProfileFillScreenState extends State<ProfileFillScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    UserData.name = _fullNameController.text;
    ...
    if (_selectedRole == 'student') {
      ...
      if (result != null) {
        ...
        setState(() {
          _errorMessage = "Ошибка при регистрации. Попробуйте позже.";
        });
      }
    } else {
      // TODO: Регистрация преподавателя
      UserData.position = _positionController.text;
      UserData.capacity = int.tryParse(_studentsCountController.text) ?? 0;
