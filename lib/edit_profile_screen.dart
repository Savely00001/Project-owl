...
class _EditProfileScreenState extends State<EditProfileScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 20),
              _buildTextField("Кафедра", _departmentController, "Информационные технологии"),
              const SizedBox(height: 40),
              _buildButton("💾 Сохранить изменения", _saveChanges, screenWidth),
              const SizedBox(height: 15),
              _buildButton("❌ Отмена", () => Navigator.pop(context, false), screenWidth, isCancel: true),
            ],
          ),
        ),
      ),
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              Text("Проект по поиску помощи в проектах", style: TextStyle(fontSize: 12)),
            ],
          ),
        ),
      ],
  ...
  Widget _buildButton(String text, VoidCallback onTap, double screenWidth, {bool isCancel = false}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isCancel ? Colors.grey.shade300 : const Color.fromRGBO(94, 71, 61, 1),
