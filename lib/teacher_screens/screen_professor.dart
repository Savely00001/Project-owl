      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border(
              bottom: BorderSide(
                color: isSelected ? TeacherTheme.primaryBrown : Colors.grey.shade300,
                width: 2,
              ),
            ),
          ),
          child: Text(
            ...
            style: TextStyle(
              ...
              color: isSelected ? TeacherTheme.primaryBrown : Colors.black54,
            ),
          ),
        ),
      ),
          ...
          if (_selectedTab == 1)
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Text('Фильтр', style: TextStyle(color: Colors.black54)),
              ),
            ),
        ],
      ),
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Text(chat['time']!, style: const TextStyle(fontSize: 12, color: Colors.black54)),
              ],
            ),
          ),
        );
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Row(
            children: [
              const Text('Фильтры:', style: TextStyle(fontSize: 14, color: Colors.black54)),
              const SizedBox(width: 10),
              GestureDetector(
                onTap: _showFilterDialog,
                child: const Text(
  ...
  Widget _buildNotificationsList() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: const Icon(Icons.notifications, size: 42, color: TeacherTheme.goldIcon),
