      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "Выбранные направления, с которыми я готов работать:",
              style: TextStyle(fontSize: 14),
            ),
          ),
          Padding(
            padding: const EdgeInsets.only(left: 30),
            child: ProfBottonText(
          ...
          const Padding(
            padding: EdgeInsets.only(top: 30, left: 30, bottom: 10),
            child: Text(
              "Количество студентов, которых готов курировать:",
              style: TextStyle(fontSize: 14),
            ),
          ),
          Padding(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const EditProfessorProfileScreen(),
          ),
        );
      },
      child: Container(
