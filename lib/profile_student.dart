        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: const Color.fromRGBO(199, 199, 199, 1), width: 1),
            ),
            child: Row(
              children: [
                const Icon(Icons.account_circle, size: 42, color: Color.fromRGBO(224, 167, 87, 1)),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(_name.isEmpty ? "Не указано" : _name, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
                          const SizedBox(width: 10),
                          Text(_group.isEmpty ? "Группа не указана" : _group, style: const TextStyle(fontSize: 14)),
                        ],
                      ),
                      Text(_department.isEmpty ? "Кафедра не указана" : _department, style: const TextStyle(fontSize: 14)),
                    ],
                  ),
                ),
              ],
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                final profileStudentState = context.findAncestorStateOfType<_ProfileStudent>();
